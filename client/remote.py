...
broadcast_id = requests.post(url='http://127.0.0.1:5000/broadcasts/').json()['broadcast_id']
...
time.sleep(1.0)
r = requests.post('http://127.0.0.1:5000/broadcasts/%s' % broadcast_id, data=json.dumps({'url': url}), headers={'content-type': 'application/json'})
